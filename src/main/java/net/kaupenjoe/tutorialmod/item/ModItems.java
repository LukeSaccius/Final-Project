...
public class ModItems {
        ...
        public static final RegistryObject<Item> ALEXANDRITE_CHESTPLATE = registerItem("alexandrite_chestplate",
                        (properties) -> new ArmorItem(ModArmorMaterials.ALEXANDRITE_ARMOR_MATERIAL,
        ...
        public static final RegistryObject<Item> ALEXANDRITE_HORSE_ARMOR = registerItem("alexandrite_horse_armor",
                        (properties) -> new AnimalArmorItem(ModArmorMaterials.ALEXANDRITE_ARMOR_MATERIAL,
                                        AnimalArmorItem.BodyType.EQUESTRIAN,
                                        properties.stacksTo(1)));

        public static final RegistryObject<Item> KAUPEN_SMITHING_TEMPLATE = registerItem(
        ...
        public static final RegistryObject<Item> HONEY_BERRIES = registerItem("honey_berries",
                        (properties) -> new BlockItem(ModBlocks.HONEY_BERRY_BUSH.get(),
                                        properties.food(ModFoodProperties.HONEY_BERRY)));

        public static final RegistryObject<Item> SWIFTNESS_BERRY = registerItem("swiftness_berry",
                        (properties) -> new Item(properties.food(ModFoodProperties.SWIFTNESS_BERRY,
                                        ModFoodProperties.SWIFTNESS_BERRY_EFFECT)));

        public static final RegistryObject<Item> ENCHANTED_SWIFTNESS_BERRY = registerItem("enchanted_swiftness_berry",
                        (properties) -> new Item(properties.food(ModFoodProperties.ENCHANTED_SWIFTNESS_BERRY_PROPERTIES,
                                        ModFoodProperties.ENCHANTED_SWIFTNESS_BERRY_EFFECT)));
